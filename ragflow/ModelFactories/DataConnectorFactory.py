...
from ragflow.utils.connectors.DataConnectorEnum import DataConnectorEnum
...
class DataConnectorFactory:
    ...
    def get_data_connector(data_connector_name: str, connector_information: dict) -> DataConnector:
        ...
        elif connector_name_enum == DataConnectorEnum.gcsblobconnector:
            return GCSBlobConnector(**connector_information)
        else:
