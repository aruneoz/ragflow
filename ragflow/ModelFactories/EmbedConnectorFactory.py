...
from ragflow.utils.embeddings.VertexAIEmbed import VertexAIEmbed
from ragflow.utils.embeddings.EmbedConnectorEnum import EmbedConnectorEnum
...
class EmbedConnectorFactory:
    ...
    def get_embed(embed_name: str, embed_information: dict) ->EmbedConnector:
        ...
        elif embed_connector_enum == EmbedConnectorEnum.vertexaiembed:
            return VertexAIEmbed(**embed_information)
        else:
