...
from ragflow.utils.sink.AlloyDBVectorStore import AlloyDBSink
from ragflow.utils.sink.SinkConnectorEnum import SinkConnectorEnum
...
class SinkConnectorFactory:
    ...
    def get_sink(sink_name: str, sink_information: dict) -> SinkConnector:
        ...
        elif sink_connector_enum == SinkConnectorEnum.alloydbsink:
            return AlloyDBSink(**sink_information)
        else:
